...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~vt8w0R5a",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by 𝛁𝚰𝚪𝐆𝚰𝚴𝚩𝚪𝚵𝚫𝐊𝚵𝚪',
  AUTO_DOWNLOAD: process.env.AUTO_DOWNLOAD !== undefined ? process.env.AUTO_DOWNLOAD === 'true' : false,
  AUTO_READ_MESSAGES: process.env.AUTO_READ_MESSAGES !== undefined ? process.env.AUTO_READ_MESSAGES === 'false' : true,
  ...
  OWNER_NAME: process.env.OWNER_NAME || "𝛁𝚰𝚪𝐆𝚰𝚴𝚩𝚪𝚵𝚫𝐊𝚵𝚪",
